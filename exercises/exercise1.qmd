...
text into a single document: **markdown**!
...
## About Quarto markdown

[Quarto](https://quarto.org/) is a tool for creating documents that combine code, results, and narrative text in one file. Like Jupyter notebooks, Quarto markdown documents provide a cleaner, more professional, more reproducible way to publish analyses compared to plain code scripts.
...
You can download a ZIP archive containing *markdown.qmd* [here](markdown.zip)

Have a look at the code in the *markdown.qmd* file and make sure that you 
...
1. Click the ![render button](figures/render.png) button to compile the file into an HTML document. 
...
- Please use Quarto markdown to prepare your work for this course, and submit both the 
`qmd` and HTML files whenever you need to hand in exercises or assignments. 
